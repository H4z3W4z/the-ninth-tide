...
Mike approved `art/concepts/kitchen-room-master-v1.png` with “Looks good. Proceed.” Preserve its straight-on blue service door, stove, warm pendant lamp, compact correction board, shelves, long supper table and large right-hand weather window. It is a 1448 × 1086 master in the established maritime illustration direction. Eight illustrated bowls in the reference are a composition study; exact P07 placement and the ninth square-patched bowl belong to independent puzzle state.

The fixed clean base owns architecture and furniture. Reuse the R04 exterior sources through R05's measured source-to-pane mapping instead of regenerating the room for each tide. First playable entry is already weather appearance two, after P06; appearances three through eight follow shared milestones and Tide IX holds eight. Fixed positions, local warm light and legible evidence persist as the sea darkens. A mood plate must never install bowls, open the drawer, consume tokens or amend the board.

Exact initials, place marks, serving tally, token fit, three-cut seal and amendment text are authored graphics. The original official eight stays visible beside the correction. P07's spoon lift and P09's condensation over the duplicate board are separate local reveals with retained evidence. Nora's physical repaired cup remains in R06 for P08/P22; R05 carries its provisioning-page repair sketch. The unsigned square-patched supper bowl is a different object, recognized again in P15's reflection. See [Kitchen and Mess assets](kitchen-room-assets.md) for progression, evidence and integration requirements.
